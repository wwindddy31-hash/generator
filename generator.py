...
# ── ЦВЕТА ─────────────────────────────────────────────────────────
R  = '\033[1;31m'   # Красный жирный
P  = '\033[1;35m'   # Розовый/Маджента
C  = '\033[1;36m'   # Голубой
W  = '\033[1;37m'   # Белый
Y  = '\033[1;33m'   # Жёлтый
G  = '\033[1;32m'   # Зелёный
D  = '\033[2;31m'   # Тёмно-красный
NC = '\033[0m'      # Сброс
...
""")
    ...
    print(f"{D}  {'─'*65}{NC}")
    print(f"{R}  Автор  {W}:{P} t.me/your_channel{NC}")
...
TRANS = str.maketrans(
    ...
    "abvgdeyezhziyklmnoprstufhtchshshyeyuya"
)
...
def gen_email(name):
    base = name.lower().split()[1].translate(TRANS)
    return f"{base}{random.randint(1,999)}@{random.choice(DOMAINS)}"

def gen_phone():
    ops = ["900","901","902","903","904","905","906","908","909","910",
           "911","912","913","914","915","916","917","918","919","920",
           "921","922","923","924","925","926","927","928","929","930",
           "950","951","952","953","960","961","962","963","964","965",
           "966","985","986","987","988","989","999"]
